...
static int ec_protect_write_block(struct cloudbacker_store *backerstore, cb_block_t block_num, const void *src, u_char *md5,
  check_cancel_t *check_cancel, void *check_cancel_arg);
static int ec_protect_read_block_part(struct cloudbacker_store *backerstore, cb_block_t block_num, u_int off, u_int len, void *dest);
static int ec_protect_write_block_part(struct cloudbacker_store *backerstore, cb_block_t block_num, u_int off, u_int len, const void *src);
static int ec_protect_flush(struct cloudbacker_store *backerstore);
static void ec_protect_destroy(struct cloudbacker_store *backerstore);
...
static int ec_protect_list_blocks(struct cloudbacker_store *backerstore, block_list_func_t *callback, void *arg);
...
ec_protect_create(struct ec_protect_conf *config, struct cloudbacker_store *inner)
{
    ...
    backerstore->meta_data = ec_protect_meta_data;
    backerstore->set_mounted = ec_protect_set_mounted;
    backerstore->read_block = ec_protect_read_block;
    backerstore->write_block = ec_protect_write_block;
    backerstore->read_block_part = ec_protect_read_block_part;
    backerstore->write_block_part = ec_protect_write_block_part;
    backerstore->list_blocks = ec_protect_list_blocks;
    backerstore->flush = ec_protect_flush;
    backerstore->destroy = ec_protect_destroy;
...
static int
ec_protect_set_mounted(struct cloudbacker_store *backerstore, int *old_valuep, int new_value)
{
    struct ec_protect_private *const priv = backerstore->data;
...
static int
ec_protect_flush(struct cloudbacker_store *const backerstore )
{
    struct ec_protect_private *const priv = backerstore->data;
...
static void
ec_protect_destroy(struct cloudbacker_store *const backerstore)
{
    struct ec_protect_private *const priv = backerstore->data;
...
void
ec_protect_get_stats(struct cloudbacker_store *backerstore, struct ec_protect_stats *stats)
{
    struct ec_protect_private *const priv = backerstore->data;
...
static int
ec_protect_list_blocks(struct cloudbacker_store *backerstore, block_list_func_t *callback, void *arg)
{
    struct ec_protect_private *const priv = backerstore->data;
...
static int
ec_protect_read_block(struct cloudbacker_store *const backerstore, cb_block_t block_num, void *dest,
  u_char *actual_md5, const u_char *expect_md5, int strict)
{
    struct ec_protect_private *const priv = backerstore->data;
...
static int
ec_protect_write_block(struct cloudbacker_store *const backerstore, cb_block_t block_num, const void *src, u_char *caller_md5,
  check_cancel_t *check_cancel, void *check_cancel_arg)
{
    struct ec_protect_private *const priv = backerstore->data;
    struct ec_protect_conf *const config = priv->config;
...
static int
ec_protect_read_block_part(struct cloudbacker_store *backerstore, cb_block_t block_num, u_int off, u_int len, void *dest)
{
    struct ec_protect_private *const priv = backerstore->data;
    struct ec_protect_conf *const config = priv->config;
...
static int
ec_protect_write_block_part(struct cloudbacker_store *backerstore, cb_block_t block_num, u_int off, u_int len, const void *src)
{
    struct ec_protect_private *const priv = backerstore->data;
    struct ec_protect_conf *const config = priv->config;
