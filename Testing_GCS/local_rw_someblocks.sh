...
printf "\n\033[1;34m******************************Start local_rw_someblocks.sh script**********************************\033[0m\n"
...
printf "\033[1;34mNow mount with localstore and write 5 blocks to local store\033[0m\n"
...
printf "\n\033[1;34mcompare wrtTolcl5_rdFrmcld10.txt and readFromlocalcloud5.txt to confirm if read write worked correctly.\033[0m\n"
...
printf "\n\033[1;34m************************************End local_rw_someblocks.sh script*******************************************\033[0m\n"
