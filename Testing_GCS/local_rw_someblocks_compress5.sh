...
printf "\n\033[1;34m******************************Start local_rw_someblocks_compress5.sh script**********************************\033[0m\n"

printf "\033[1;34mThis script writes 10 blocks of BS=4K to cloud store using compression level 5. write 5 blocks to local store.\033[0m\n"
...
runthis "../cloudbacker --accessFile=/home/build/.s3backer_passwd_gcs --size=10M --blockSize=4K gs://gcs-nearline-sujatha /mnt/source/ --listBlocks --encrypt --compress=5 --password=abcd"
...
runthis "../cloudbacker --accessFile=/home/build/.s3backer_passwd_gcs --size=10M --blockSize=4K gs://gcs-nearline-sujatha /mnt/source/ --listBlocks --localStore=/dev/loop0  --encrypt --compress=5  --password=abcd"
...
printf "\n\033[1;34m************************************End local_rw_someblocks_compress5.sh script*******************************************\033[0m\n"
