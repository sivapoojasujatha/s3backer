...
runthis "../cloudbacker --accessFile=/home/build/.s3backer_passwd_gcs --size=10M --blockSize=4K --prefix=xyz gs://gcs-nearline-sujatha --erase --force"
runthis "../cloudbacker --accessFile=/home/build/.s3backer_passwd_gcs --size=10M --blockSize=4K --prefix=abc gs://gcs-nearline-sujatha --erase --force"
...
runthis "../cloudbacker --accessFile=/home/build/.s3backer_passwd_gcs --size=10M --blockSize=4K --prefix=xyz gs://gcs-nearline-sujatha /mnt/source/ --listBlocks --localStore=/dev/loop0"
...
runthis "../cloudbacker --accessFile=/home/build/.s3backer_passwd_gcs --size=10M --blockSize=4K --prefix=abc gs://gcs-nearline-sujatha /mnt/source/ --listBlocks --localStore=/dev/loop0"
...
runthis "../cloudbacker --accessFile=/home/build/.s3backer_passwd_gcs --size=10M --blockSize=4K gs://gcs-nearline-sujatha /mnt/source/ --listBlocks --localStore=/dev/loop0"
...
runthis "../cloudbacker --accessFile=/home/build/.s3backer_passwd_gcs --size=10M --blockSize=4K --prefix=xyz gs://gcs-nearline-sujatha --erase --force --localStore=/dev/loop0"
runthis "../cloudbacker --accessFile=/home/build/.s3backer_passwd_gcs --size=10M --blockSize=4K --prefix=abc gs://gcs-nearline-sujatha --erase --force --localStore=/dev/loop0"
runthis "../cloudbacker --accessFile=/home/build/.s3backer_passwd_gcs --size=10M --blockSize=4K gs://gcs-nearline-sujatha --erase --force --localStore=/dev/loop0"
